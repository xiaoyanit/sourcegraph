...
function initCodeIntelligence(
    ...
    const { fetchHover } = shouldUseExtensions ? createLSPFromExtensions(extensionsController) : lspViaAPIXlang
    ...
    const hoverifier = createHoverifier<RepoSpec & RevSpec & FileSpec & ResolvedRevSpec, HoverMerged, ActionItemProps>({
        ...
        fetchActions: context => getHoverActions({ extensionsController, platformContext }, context),
    })
